...
const HeaderRecension = () => {
  ...
  return (
    <section className="bg-[url('/recentioner/header.webp')] bg-[center_top_0rem]  w-full h-[300px] bg-cover flex items-end justify-center md:h-[500px] md:bg-[center_top_58rem] md:items-center">
