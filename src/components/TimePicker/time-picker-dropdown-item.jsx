...
const TimePickerDropdownItem = ({
  ...
  return (
    <div
      ...
      ref={itemRef}
      className={twMerge(
        "text-center text-xs text-[#5F6952] w-full cursor-pointer rounded-md flex items-center justify-center py-1 px-2 font-semibold hover:bg-white/10",
        isSelected && "bg-orange-800 hover:bg-orange-800 text-white"
      )}
      onClick={onClick}
    >
